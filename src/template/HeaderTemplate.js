        ...
        return (
            <div>
                ...
                <header className="main-header">
                    ...
                    <a href="/" className="logo" style={{backgroundColor: '#555299'}}>
                    ...
                    <nav className="navbar navbar-static-top" style={{backgroundColor: '#605ca8'}}>
                        ...
                        <div className="navbar-custom-menu">
                            <ul className="nav navbar-nav">
                                ...
                                <li className="dropdown messages-menu" style={{backgroundColor: '#605ca8'}}>
                                ...
                                <li className="dropdown notifications-menu" style={{backgroundColor: '#605ca8'}}>
                                    <a href="#" className="dropdown-toggle" data-toggle="dropdown"
                                       aria-expanded="false">
                                ...
                                <li className="dropdown tasks-menu" style={{backgroundColor: '#605ca8'}}>
                                    <a href="#" className="dropdown-toggle" data-toggle="dropdown"
                                       aria-expanded="false">
                                ...
                                <li className="dropdown user user-menu" style={{backgroundColor: '#605ca8'}}>
                                    <a href="#" className="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <li style={{backgroundColor: '#605ca8'}}>
